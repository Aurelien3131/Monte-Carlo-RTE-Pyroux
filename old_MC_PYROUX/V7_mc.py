# MC_PYROUX_V7 : montecarlo core + one material + pencil beam + gaussian beam + detector + multimaterial + plane wave + condition cyclique x/y
# + custom phase function + polar + boucle sur Lz + boucle sur polarisation + boucle sur longueur d'onde + boucle sur densité brouillard + time
...
# ==========================================================
Nphoton = 1000000	# nombre de photons à simuler
...
for zSize in LZ_values:
    ...
    for lambada in Lambda_values:
        for dense in density_values:
            ...
            tmin = ((zdet-zinit)/ (c_velos * 100) / 1) # z en cm et c_velos en m/s donc * 100 
            ...
            for pol_name, stokes in polar_inputs.items():
                ...
                histo = Histogramme(time_in=1.6678e-5, time_out=1.6680e-5, time_bin=bins) #initialisation de l'histogramme temporel
                ...
                nom_histo = ("histo_small_10_v_"+str(dense)+"_l_"+str(lambada)+"_z_" + str(zSize) + "_pol_" + str(pol_name) + ".txt")
