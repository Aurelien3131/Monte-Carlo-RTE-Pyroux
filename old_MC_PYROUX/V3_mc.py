# MC_PYROUX_V3 : montecarlo core + one material + pencil beam + gaussian beam + detector + multimaterial + plane wave 
...
zSize = 25	# [cm] boite va de 0 à zSize
...
idx_mat1 = box.add_material(mua=1e-2, mus=0.1, g=0.5, n=1.33)
# matériau 2 : materiau 2
idx_mat2 = box.add_material(mua=0.1, mus=0.01, g=0.85, n=1)
