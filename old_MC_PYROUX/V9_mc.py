# MC_PYROUX_V9 : montecarlo core + one material + pencil beam + gaussian beam + detector + multimaterial + plane wave + condition cyclique x/y
...
# + time + signal modulé + construit histogramme temporelle des photons émis
