...
This code implements a parallelized radiative transport solver for simulating photon propagation in turbid media (fog, aerosols, dust, particles media).
...
main.py
  ...
  - Initializes geometry, source, and detectors
...
simulation.py
  ...
  - Photon-medium interaction management
...
2. Initializes the voxelized geometry.
...
- Temporal histograms (main detector)
