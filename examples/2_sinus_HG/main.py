...
for zSize in LZ_values: #  Loop over the simulation box thicknesses (Lz)
    ...
    for lambada in Lambda_values: # Loop over wavelength
        for mux in muss: # Loop over fog densities (the phase-function filename and optical parameters depend on density and wavelength).
        # ====================================================================================================================
        # Media parameters
            ...
            for pol_name, stokes in polar_inputs.items(): # boucle sur les polarisations d'entrÃ©es
                for freq in frequency :
                    for fact_modu in modulation :
                        ...
                        print("mus = ",mux)
                        time_window = (nb_period/freq)+(nb_period/freq)
                ...
                # Create the “result” folder if it does not exist
                        ...
                        nom_fichier = ("result/log_HG_mus_"+str(mux)+"_freq_"+str(freq)+"_m_"+str(fact_modu)+"_v_"+str(dense)+"_l_"+str(lambada)+"_z_" + str(zSize) + "_pol_" + str(pol_name) + ".txt")
                        nom_histo = ("result/histo_HG_mus_"+str(mux)+"_freq_"+str(freq)+"_m_"+str(fact_modu)+"_v_"+str(dense)+"_l_"+str(lambada)+"_z_" + str(zSize) + "_pol_" + str(pol_name) + ".txt")
                        nom_sub_histo = ("result/sub_histo_HG_mus_"+str(mux)+"_freq_"+str(freq)+"_m_"+str(fact_modu)+"_v_"+str(dense)+"_l_"+str(lambada)+"_z_" + str(zSize) + "_pol_" + str(pol_name) + ".txt")
                        nom_emit_histo = ("result/histo_emit_HG_mus_"+str(mux)+"_freq_"+str(freq)+"_m_"+str(fact_modu)+"_v_"+str(dense)+"_l_"+str(lambada)+"_z_" + str(zSize) + "_pol_" + str(pol_name) + ".txt")
