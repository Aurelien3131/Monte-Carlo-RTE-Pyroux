...
def simulation_worker( nphotons, box, xSize, ySize, zSize, xdet, ydet, zdet, thetadet, phidet, diametre, NA, t_ballistic, time_gate, time_window, bins, freq, nb_period, boundary_function, source_function, source_params, stokes_input, worker_id=None, worker_seed=None):
...
def run_simulation(box, xSize, ySize, zSize, xdet, ydet, zdet, thetadet, phidet, diametre, NA, t_ballistic, time_gate, time_window, bins, freq, nb_period, boundary_function, source_function, source_params, stokes_input):
    ...
    if NPROC == 1:
        ...
        return simulation_worker( Nphoton, box, xSize, ySize, zSize, xdet, ydet, zdet, thetadet, phidet, diametre, NA, t_ballistic, time_gate, time_window, bins, freq, nb_period, boundary_function, source_function, source_params, stokes_input)
    ...
    for i,n in enumerate(photons):
        ...
        tasks.append((n, box, xSize, ySize, zSize, xdet, ydet, zdet, thetadet, phidet, diametre, NA, t_ballistic, time_gate, time_window, bins, freq, nb_period, boundary_function, source_function, source_params, stokes_input, i, worker_seed))
